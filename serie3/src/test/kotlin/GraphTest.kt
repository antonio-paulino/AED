...
class GraphTest {
    ...
    fun testIterator() {
        ...
        val vertex1 = iterator.next()
        assertEquals(1, vertex1.id)
        assertEquals("V1", vertex1.data)

        assertTrue(iterator.hasNext())

        val vertex2 = iterator.next()
        assertEquals(2, vertex2.id)
        assertEquals("V2", vertex2.data)

        assertTrue(iterator.hasNext())

        val vertex3 = iterator.next()
        assertEquals(3, vertex3.id)
        assertEquals("V3", vertex3.data)
